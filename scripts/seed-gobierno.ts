...
async function seed() {
  ...
  console.log('     - gov_admin@incluai.com.ar')
  console.log('     - gov_supervisor@incluai.com.ar')
  console.log('     - gov_analyst@incluai.com.ar')
  console.log('  2. Asociarlos a gov_users con:')
  console.log(`     INSERT INTO gov_users(user_id,jurisdiction_id,role) VALUES`)
  console.log(`       ((SELECT id FROM auth.users WHERE email='gov_admin@incluai.com.ar'),`)
