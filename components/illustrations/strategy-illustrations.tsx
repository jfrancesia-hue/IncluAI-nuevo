...
function AgendaIllustration({ className }: P) {
  return (
    <svg viewBox="0 0 280 160" className={className} aria-hidden>
      <rect x="70" y="20" width="140" height="120" rx="10" fill="white" stroke="#27AE60" strokeWidth="2.5" />
      <rect x="85" y="35" width="110" height="12" rx="3" fill="#27AE60" />
      <g>
        <rect x="85" y="55" width="24" height="24" rx="4" fill="#fde68a" />
        <circle cx="97" cy="67" r="6" fill="#E67E22" />
      </g>
      <g>
        <rect x="113" y="55" width="24" height="24" rx="4" fill="#bfdbfe" />
        <path d="M118 72 L125 60 L131 70 L137 63" stroke="#2E86C1" strokeWidth="2" fill="none" />
      </g>
      <g>
        <rect x="141" y="55" width="24" height="24" rx="4" fill="#fecaca" />
        <rect x="147" y="61" width="12" height="12" fill="#E67E22" />
      </g>
      <g>
        <rect x="169" y="55" width="24" height="24" rx="4" fill="#c4b5fd" />
        <circle cx="181" cy="67" r="7" stroke="#2E86C1" strokeWidth="2" fill="none" />
      </g>
      <rect x="85" y="90" width="16" height="16" rx="3" fill="#27AE60" />
      <path d="M88 98 L92 102 L98 94" stroke="white" strokeWidth="2.5" fill="none" />
      <rect x="105" y="90" width="16" height="16" rx="3" fill="#27AE60" />
...
function MaterialIllustration({ className }: P) {
  return (
    <svg viewBox="0 0 280 160" className={className} aria-hidden>
      <rect x="30" y="25" width="220" height="110" rx="8" fill="#2E86C1" />
      <rect x="50" y="45" width="180" height="14" rx="3" fill="#E67E22" />
      <text x="140" y="56" fontSize="10" fill="white" textAnchor="middle" fontFamily="DM Sans">1 entero</text>
      <rect x="50" y="65" width="87" height="14" rx="3" fill="#27AE60" />
      <rect x="140" y="65" width="87" height="14" rx="3" fill="#27AE60" />
...
function RelojPausaIllustration({ className }: P) {
  return (
    <svg viewBox="0 0 280 160" className={className} aria-hidden>
      <circle cx="110" cy="80" r="52" fill="white" stroke="#2E86C1" strokeWidth="3" />
      <circle cx="110" cy="80" r="4" fill="#2E86C1" />
      <path d="M110 80 L110 42" stroke="#2E86C1" strokeWidth="3" />
      <path d="M110 80 L140 92" stroke="#27AE60" strokeWidth="3" />
      <g stroke="#2E86C1" strokeWidth="2">
        <line x1="110" y1="32" x2="110" y2="38" />
        <line x1="158" y1="80" x2="152" y2="80" />
        <line x1="110" y1="128" x2="110" y2="122" />
        <line x1="62" y1="80" x2="68" y2="80" />
      </g>
      <path d="M110 80 L110 28 A52 52 0 0 1 162 80 Z" fill="#27AE60" opacity=".2" />
      ...
      <text x="225" y="115" fontSize="11" fill="#2E86C1" textAnchor="middle" fontWeight="600">
        +50% tiempo
      </text>
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 280 160" className={className} aria-hidden>
      <g>
        ...
        <rect x="85" y="94" width="40" height="45" rx="10" fill="#27AE60" />
      ...
      <g>
        ...
        <rect x="160" y="94" width="40" height="45" rx="10" fill="#E67E22" />
        <text x="180" y="135" fontSize="9" fill="white" fontWeight="700" textAnchor="middle">
          NARRADOR
        </text>
      </g>
      <rect x="120" y="100" width="45" height="18" rx="4" fill="#FBF8F2" stroke="#2E86C1" strokeWidth="2" />
      <rect x="128" y="104" width="12" height="10" rx="2" fill="#E67E22" />
      <rect x="142" y="104" width="12" height="10" rx="2" fill="#E67E22" />
      <path d="M130 50 Q142 30 155 50" stroke="#2E86C1" strokeWidth="2.5" fill="none" markerEnd="url(#ill-ar)" />
      <defs>
...
function RutinaIllustration({ className }: P) {
  return (
    <svg viewBox="0 0 280 160" className={className} aria-hidden>
      <circle cx="60" cy="80" r="22" fill="#fde68a" stroke="#E67E22" strokeWidth="2.5" />
      <text x="60" y="85" fontSize="11" fontWeight="700" fill="#78350f" textAnchor="middle">1</text>
      <path d="M82 80 h26" stroke="#E67E22" strokeWidth="3" strokeDasharray="4 3" />
      <circle cx="130" cy="80" r="22" fill="#bfdbfe" stroke="#2E86C1" strokeWidth="2.5" />
      <text x="130" y="85" fontSize="11" fontWeight="700" fill="#2E86C1" textAnchor="middle">2</text>
      <path d="M152 80 h26" stroke="#E67E22" strokeWidth="3" strokeDasharray="4 3" />
      <circle cx="200" cy="80" r="22" fill="#D6F0E0" stroke="#27AE60" strokeWidth="2.5" />
      <text x="200" y="85" fontSize="11" fontWeight="700" fill="#14532d" textAnchor="middle">3</text>
      <path d="M60 120 l0 12" stroke="#27AE60" strokeWidth="2" />
      <path d="M130 120 l0 12" stroke="#27AE60" strokeWidth="2" />
      <path d="M200 120 l0 12" stroke="#27AE60" strokeWidth="2" />
    </svg>
  );
}
...
function RecursoDigitalIllustration({ className }: P) {
  return (
    <svg viewBox="0 0 280 160" className={className} aria-hidden>
      <rect x="60" y="30" width="160" height="100" rx="8" fill="white" stroke="#2E86C1" strokeWidth="3" />
      <rect x="60" y="30" width="160" height="18" rx="8" fill="#2E86C1" />
      <circle cx="72" cy="39" r="3" fill="#f87171" />
      <circle cx="82" cy="39" r="3" fill="#fbbf24" />
      <circle cx="92" cy="39" r="3" fill="#27AE60" />
      <rect x="75" y="60" width="130" height="10" rx="2" fill="#e2e8f0" />
      <rect x="75" y="78" width="90" height="10" rx="2" fill="#27AE60" />
      <rect x="75" y="96" width="110" height="10" rx="2" fill="#e2e8f0" />
      <rect x="75" y="114" width="60" height="10" rx="2" fill="#E67E22" />
    </svg>
  );
}
...
function GenericIllustration({ className }: P) {
  return (
    <svg viewBox="0 0 280 160" className={className} aria-hidden>
      <circle cx="140" cy="80" r="50" fill="#D6F0E0" />
      <path d="M120 80 l12 12 l28 -28" stroke="#27AE60" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      <circle cx="60" cy="40" r="4" fill="#fbbf24" />
      <circle cx="230" cy="60" r="3" fill="#E67E22" />
